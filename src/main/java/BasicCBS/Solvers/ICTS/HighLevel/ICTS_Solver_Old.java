...
public class ICTS_Solver_Old extends A_Solver {

//    I_Solver lowLevelSolver;
    I_OpenList<ICTS_Node_Old> openList;
    ICTS_Solver_Old.OpenListManagementMode openListManagementMode;
...
//    Comparator<? super ICTS_Node> cbsNodeComparator;
    ...
    //todo: complete
    private void expandNode(ICTS_Node_Old node) {
        this.expandedNodes++;
...
//        addToOpen(node.rightChild);
    ...
    private boolean addToOpen(ICTS_Node_Old node) {
     ...
     * Creates a root node.
     */
    private ICTS_Node_Old generateRoot(ConstraintSet initialConstraints) {
        this.generatedNodes++;
        ...
        return new ICTS_Node_Old(solution, costFunction.solutionCost(solution, this));
    }
    ...
    public ICTS_Solver_Old(I_Solver lowLevelSolver, I_OpenList<ICTS_Node_Old> openList, ICTS_Solver_Old.OpenListManagementMode openListManagementMode,
                           ICTSCostFunction costFunction, Comparator<? super ICTS_Node_Old> ictsNodeComparator) {
...
public enum OpenListManagementMode{
     ...
     * after every run, and initialize OPEN at the start of every run with a single root {@link ICTS_Node_Old node}.
     */
    AUTOMATIC,
    /**
