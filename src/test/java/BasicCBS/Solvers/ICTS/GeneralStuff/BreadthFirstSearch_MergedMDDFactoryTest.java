...
public class BreadthFirstSearch_MergedMDDFactoryTest {
    ...
    private Agent agent33to24 = new Agent(0, coor33, coor24);
    private Agent agent33to22 = new Agent(0, coor33, coor22);
    private Agent agent32to12 = new Agent(1, coor32, coor12);
    private Agent agent14to32 = new Agent(1, coor14, coor32);
    private Agent agent33to55 = new Agent(0, coor33, coor55);
    private Agent agent22to12 = new Agent(1, coor22, coor12);
    private Agent agent22to13 = new Agent(1, coor22, coor13);
    private Agent agent14to34 = new Agent(2, coor14, coor34);
    private Agent agent33to45 = new Agent(0, coor33, coor45);
    private Agent agent13to24 = new Agent(0, coor13, coor24);
    private Agent agent34to13 = new Agent(1, coor34, coor13);
    private Agent agent32to34 = new Agent(2, coor32, coor34);
